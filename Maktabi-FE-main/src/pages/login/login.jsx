...
import { signIn } from '../../scripts/APIs';
import { storeTokenInLocalStorage } from '../../scripts/common';
...
export default function Login(props) {
    ...
    async function handleLogin() {
        ...
        if (!passError && !emailError) {
            try {
                const response = await signIn(emailValue.current.value, passValue.current.value);
                    ...
                    <div className="login-form">
                        <form>
                            ...
                            <div className='login-input-container'>
                                ...
                                <a className='mb-3 forgot-text align-self-end'>Forgot email or password?</a>
